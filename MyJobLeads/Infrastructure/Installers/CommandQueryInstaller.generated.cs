...
namespace MyJobLeads.Infrastructure.Installers
{
    public class CommandAndQueryInstaller : IWindsorInstaller
    {
        public void Install(IWindsorContainer container, IConfigurationStore store)
        {
			...
			container.Register(Component.For<CreateUserCommandParams>().ImplementedBy<CreateUserCommandParams>().LifeStyle.PerWebRequest);			
			...
			container.Register(Component.For<CreateTaskCommandParams>().ImplementedBy<CreateTaskCommandParams>().LifeStyle.PerWebRequest);			
			container.Register(Component.For<CreateTaskCommand>().ImplementedBy<CreateTaskCommand>().LifeStyle.PerWebRequest);			
			container.Register(Component.For<StartNextJobSearchMilestoneCommandParams>().ImplementedBy<StartNextJobSearchMilestoneCommandParams>().LifeStyle.PerWebRequest);			
			container.Register(Component.For<StartNextJobSearchMilestoneCommand>().ImplementedBy<StartNextJobSearchMilestoneCommand>().LifeStyle.PerWebRequest);			
			...
			container.Register(Component.For<EditTaskCommandParams>().ImplementedBy<EditTaskCommandParams>().LifeStyle.PerWebRequest);			
			...
			container.Register(Component.For<OrganizationByRegistrationTokenQueryParams>().ImplementedBy<OrganizationByRegistrationTokenQueryParams>().LifeStyle.PerWebRequest);			
			container.Register(Component.For<OrganizationByRegistrationTokenQuery>().ImplementedBy<OrganizationByRegistrationTokenQuery>().LifeStyle.PerWebRequest);					
		}
	}
}