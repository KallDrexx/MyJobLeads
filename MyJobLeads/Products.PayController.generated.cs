...
namespace MyJobLeads.Areas.Products.Controllers {
    public partial class PayController {
        ...
        protected PayController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Pay";
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_PayController: MyJobLeads.Areas.Products.Controllers.PayController {
        public T4MVC_PayController() : base(Dummy.Instance) { }
