...
namespace MyJobLeads.Controllers {
    public partial class ContactController {
        ...
        public class ViewNames {
            ...
            public readonly string View = "~/Views/Contact/View.cshtml";
        }
    }
    ...
    public class T4MVC_ContactController: MyJobLeads.Controllers.ContactController {
        ...
        public override System.Web.Mvc.ActionResult Edit(MyJobLeads.DomainModel.Entities.Contact contact, int companyId) {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.Edit);
