...
namespace MyJobLeads.Areas.Products.Controllers {
    public partial class OrderController {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public OrderController Actions { get { return MVC.Products.Order; } }
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_OrderController: MyJobLeads.Areas.Products.Controllers.OrderController {
        public T4MVC_OrderController() : base(Dummy.Instance) { }

        public override System.Web.Mvc.ActionResult Confirm(int productId) {
