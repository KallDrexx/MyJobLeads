...
namespace MyJobLeads.Tests.Data
{
    ...
    public class InMemoryUnitOfWorkTests
    {
        ...
        public void Can_Add_New_Entities()
        {
            ...
            // Verify
            _unitOfWork.Commit();
            Assert.AreEqual(1, _unitOfWork.UnitTestEntities.Fetch().Count(), "Repository has an incorrect number of entities");
        }
        ...
        public void Can_Remove_Entities()
        {
            ...
            // Verify
            Assert.AreEqual(0, _unitOfWork.UnitTestEntities.Fetch().Count(), "Repository has an incorrect number of entities");
        }
